...
void main() {
  ...
  group('cacheFirstTimer', () {
    ...
    test(
        'should throw a [CacheExcception] when there is an error caching the data',
        () async {
  ...
  group('checIfUserIsFirstTimer', () {
    test(
        'should call [SharedPreferences] to check if user is first timer and return the right response from storage when data exist',
        () async {
    ...
    test(
        'should throw a [CacheException] when there is an error retriving the data',
        () async {
